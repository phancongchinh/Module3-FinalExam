...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        ...
        <ul class="navbar-nav ml-auto">
            <!-- Navbar Search -->
            <li class="nav-item">
                <a class="nav-link" data-widget="navbar-search" href="/products?action=search&id=${product.id}"
                   role="button">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="description" class="form-control" rows="4" name="description"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="quantity" class="form-control" value="${product.quantity}"
                                                   name="quantity">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="color" class="form-control" value="${product.color}"
                                                   name="color">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="categoryId" id="category" class="form-control custom-select">
