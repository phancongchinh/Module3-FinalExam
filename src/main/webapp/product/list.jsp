...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        ...
        <ul class="navbar-nav ml-auto">
            <!-- Navbar Search -->
            <li class="nav-item">
                <a class="nav-link" data-widget="navbar-search" href="/products" role="button" id="keyword"
                   name="keyword">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- Search box -->
            <div class="row">
                <form class="d-flex col-6" action="/products" method="get">
                        ...
                        <c:forEach items="${products}" var="product">
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    ...
                                    <a class="btn btn-info btn-sm" href="/products?action=update&id=${product.id}">
